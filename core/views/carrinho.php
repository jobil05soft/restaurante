            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <?php if ($carrinho == null) : ?>
                        <p class="">Não existem produtos no carrinho.</p>
                        <div class="mt-2">
                            <a href="?a=cardapio" class="btn btn-primary">Ir para a Pagina do Cardapio</a>
                        </div>
                    <?php else : ?>
                        ...
                        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col text-end">
                                    <a href="?a=cardapio" class="btn btn-sm btn-primary">Adicionar Item ao Pedido</a>
                                    <a href="?a=finalizar_pedido" class="btn btn-sm btn-primary">Finalizar Pedido</a>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
