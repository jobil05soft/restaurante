<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-2">
                <a href="?a=pedidos_instantaneos" type="button" class="btn btn-sm btn-outline-secondary">Pedidos No Restaurante</a>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col">
                <a href="?a=lista_pedidos" class="btn btn-primary btn-sm">Ver todos pedidos</a>
            </div>
            <div class="col">
                <?php
                $f = '';
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="table-responsive small">
                    ...
                    <table class="table table-striped" id="pedido">
